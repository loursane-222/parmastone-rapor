...
export default function YeniRaporPage() {
  ...
  async function kaydet(e: React.FormEvent) {
    ...
    else { router.push('/haftalik-rapor'); router.refresh() }
  }
  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6">
        ...
        <p className="text-slate-500 text-sm mt-1">Bu haftanın performans özeti</p>
      </div>
      ...
      <form onSubmit={kaydet} className="space-y-6">
        ...
        <div className="card p-6">
          <h2 className="font-semibold text-slate-800 mb-4">Değerlendirme ve Yorumlar</h2>
          <div className="space-y-4">
            {[
              { alan: 'genel_degerlendirme', etiket: 'Genel Değerlendirme', placeholder: 'Ziyaret edilen bölgeler, müşteriler ve konular...' },
              { alan: 'hedef_durumu', etiket: 'Hedeflerin Durumu', placeholder: 'Aylık/haftalık hedeflere göre neredesiniz?' },
              { alan: 'rakip_aktiviteleri', etiket: 'Rakip Aktiviteleri', placeholder: 'Rakip fiyatlar, kampanyalar, haberler...' },
              { alan: 'genel_yorum', etiket: 'Genel Yorum ve Öneriler', placeholder: 'Yöneticiye iletmek istediğiniz...' },
