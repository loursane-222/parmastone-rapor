  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/haftalik-rapor/yeni" className="btn-primary">+ Yeni Rapor</Link>
      </div>
      <div className="space-y-4">
        ...
        {raporlar.length === 0 && (
          <div className="card p-12 text-center text-slate-400">
            Henüz rapor yok. <Link href="/haftalik-rapor/yeni" className="text-brand-600 hover:underline">İlk raporu girin →</Link>
          </div>
        )}
      </div>
    </div>
