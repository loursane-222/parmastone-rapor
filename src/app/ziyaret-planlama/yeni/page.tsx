...
export default function YeniZiyaretPage() {
  ...
  const [form, setForm] = useState({
    ...
    ziyaret_tipi: 'rutin', amac: '', beklenen_sonuc: '', not: ''
  })
  ...
  async function kaydet(e: React.FormEvent) {
    ...
    else { router.push('/ziyaret-planlama'); router.refresh() }
  }
    ...
    <div className="max-w-xl">
      ...
      <form onSubmit={kaydet} className="card p-6 space-y-4">
        ...
        <div>
          ...
          <textarea className="form-input h-20 resize-none" value={form.not} onChange={e => guncelle('not', e.target.value)} placeholder="Ek notlar..." />
        </div>
